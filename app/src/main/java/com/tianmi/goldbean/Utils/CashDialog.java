...
public class CashDialog implements View.OnClickListener {
    private View dialog;
    ...
    public CashDialog(Activity activity, String title){
        this.activity = activity;
        this.title = title;
        dialog = LayoutInflater.from(activity).inflate(R.layout.dialog_cash, null);
        initViews(dialog);
    }
