...
import com.tianmi.goldbean.my.DisagreeMemberUpInfoActivity;
import com.tianmi.goldbean.my.ManagerMemberUpInfoActivity;

import java.util.List;

public class MemberUpDisagreeAdapter extends BaseAdapter {
    private Context context;
    private List<MemberUpInfoBean> list;
    private ViewHolder holder;
    public MemberUpDisagreeAdapter(Context context, List<MemberUpInfoBean> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtil.startActivity((Activity)context, DisagreeMemberUpInfoActivity.class, b);
            }
        });
