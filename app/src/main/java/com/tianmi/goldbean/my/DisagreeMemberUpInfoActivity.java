...
public class DisagreeMemberUpInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init(){
        ...
        if (bean != null){
            ...
            multiPickResultView.init(DisagreeMemberUpInfoActivity.this, MultiPickResultView.ACTION_ONLY_SHOW, (ArrayList<String>) list, 5, 0);
...
//                shenhe(1, Integer.parseInt(userId), bean.getRetweetNo());
    ...
    private void shenhe(int auditStatus, int userId, String remark){
        ...
        request.disagreeFriend(remarkEdit.getText().toString(), bean.getRetweetNo(), bean.getUserId());
